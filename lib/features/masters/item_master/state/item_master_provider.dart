...
import '../data/item_master_api.dart';
import '../models/item_master_model.dart';

class ItemMasterProvider extends BaseProvider {
  ItemMasterProvider({ItemMasterApi? api}) : _api = api ?? sl<ItemMasterApi>();

  final ItemMasterApi _api;
  ...
  List<ItemMasterModel> get filteredItems {
    final q = _searchQuery.trim().toLowerCase();
    Iterable<ItemMasterModel> list = _items;
  ...
  List<ItemMasterModel> get pagedRows {
