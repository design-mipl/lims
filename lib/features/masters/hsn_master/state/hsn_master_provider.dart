...
import '../data/hsn_master_api.dart';
import '../models/hsn_master_model.dart';

class HsnMasterProvider extends BaseProvider {
  HsnMasterProvider({HsnMasterApi? api}) : _api = api ?? sl<HsnMasterApi>();

  final HsnMasterApi _api;

  List<HsnMasterModel> _items = [];
  String _searchQuery = '';
  ...
  List<HsnMasterModel> get filteredItems {
    final q = _searchQuery.trim().toLowerCase();
    Iterable<HsnMasterModel> list = _items;
  ...
  List<HsnMasterModel> get pagedRows {
