...
import '../data/sub_assembly_master_api.dart';
import '../models/sub_assembly_master_model.dart';

class SubAssemblyMasterProvider extends BaseProvider {
  SubAssemblyMasterProvider({SubAssemblyMasterApi? api})
      : _api = api ?? sl<SubAssemblyMasterApi>();

  final SubAssemblyMasterApi _api;

  List<SubAssemblyMasterModel> _items = [];
  String _searchQuery = '';
  ...
  List<SubAssemblyMasterModel> get filteredItems {
    final q = _searchQuery.trim().toLowerCase();
    Iterable<SubAssemblyMasterModel> list = _items;
  ...
  List<SubAssemblyMasterModel> get pagedRows {
