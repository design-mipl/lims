...
import '../data/ferrography_master_api.dart';
import '../models/ferrography_master_model.dart';

class FerrographyMasterProvider extends BaseProvider {
  FerrographyMasterProvider({FerrographyMasterApi? api})
      : _api = api ?? sl<FerrographyMasterApi>();

  final FerrographyMasterApi _api;

  List<FerrographyMasterModel> _items = [];
  String _searchQuery = '';
  ...
  List<FerrographyMasterModel> get filteredItems {
    final q = _searchQuery.trim().toLowerCase();
    Iterable<FerrographyMasterModel> list = _items;
  ...
  List<FerrographyMasterModel> get pagedRows {
