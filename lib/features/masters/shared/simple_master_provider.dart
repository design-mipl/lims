...
import 'simple_master_api.dart';
import 'simple_master_model.dart';

class SimpleMasterProvider extends BaseProvider {
  SimpleMasterProvider({required SimpleMasterApi api}) : _api = api;

  final SimpleMasterApi _api;
  ...
  List<SimpleMasterModel> get filteredItems {
    final q = _searchQuery.trim().toLowerCase();
    Iterable<SimpleMasterModel> list = _items;
  ...
  List<SimpleMasterModel> get pagedRows {
