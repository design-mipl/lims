...
import '../data/problem_master_api.dart';
import '../models/problem_master_model.dart';

class ProblemMasterProvider extends BaseProvider {
  ProblemMasterProvider({ProblemMasterApi? api})
      : _api = api ?? sl<ProblemMasterApi>();

  final ProblemMasterApi _api;

  List<ProblemMasterModel> _items = [];
  String _searchQuery = '';
  ...
  List<ProblemMasterModel> get filteredItems {
    final q = _searchQuery.trim().toLowerCase();
    Iterable<ProblemMasterModel> list = _items;
  ...
  List<ProblemMasterModel> get pagedRows {
