...
class ModulesApi {
  ModulesApi() {
    _items = [
      ...
      _row(2, 'mod-sample-receipt', 'Sample Intake', 'mod-transactions',
          ModuleStatus.active),
      _row(3, 'mod-lab-code', 'Lab Code', 'mod-transactions',
          ModuleStatus.active),
      _row(4, 'mod-lab-assignment', 'Lab Manager Assignment',
          'mod-transactions', ModuleStatus.active),
      _row(5, 'mod-lab-mgr-verification', 'Lab Manager Verification',
          'mod-transactions', ModuleStatus.active),
      _row(6, 'mod-lab-verification-chemist', 'Lab Verification Chemist',
          'mod-transactions', ModuleStatus.active),
      ...
      _row(9, 'mod-action-taken', 'Action Taken', 'mod-transactions',
          ModuleStatus.active),
      _row(10, 'mod-customer-invoice', 'Customer Invoice', 'mod-transactions',
          ModuleStatus.active),
      _row(11, 'mod-credit-note', 'Credit Note', 'mod-transactions',
          ModuleStatus.active),
      _row(12, 'mod-masters', 'Masters', null, ModuleStatus.active),
      _row(13, 'mod-customer', 'Customer', 'mod-masters', ModuleStatus.active),
      _row(14, 'mod-site', 'Site', 'mod-masters', ModuleStatus.active),
      _row(15, 'mod-user-mgmt', 'User Management', null, ModuleStatus.active),
      _row(16, 'mod-departments', 'Departments', 'mod-user-mgmt',
          ModuleStatus.active),
      _row(17, 'mod-users', 'Users', 'mod-user-mgmt', ModuleStatus.active),
      _row(18, 'mod-roles', 'Roles', 'mod-user-mgmt', ModuleStatus.active),
      _row(19, 'mod-modules', 'Modules', 'mod-user-mgmt', ModuleStatus.active),
    ];
    _applyParentNames();
  }
