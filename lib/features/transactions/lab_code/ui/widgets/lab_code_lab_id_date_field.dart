...
/// From / To date fields for **Lab Id** tab toolbar only.
...
class _LabCodeLabIdDateFieldState extends State<LabCodeLabIdDateField> {
  ...
  static const double _fieldWidth = 132.0;
  ...
  Widget build(BuildContext context) {
    final fieldHeight = AppTokens.listingToolbarSearchHeight;
    final fontSize = AppTokens.textSm;
    final fillColor = AppTokens.surfaceSubtle;
